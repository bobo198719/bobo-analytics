  ...
  if (error) {
    return (
      <div className="h-full flex flex-col items-center justify-center gap-10 bg-white/5 border border-white/10 rounded-[48px] p-20 text-center animate-in fade-in duration-500">
         <div className="text-gray-500 mb-2 font-mono text-[10px] tracking-widest opacity-30">INFRASTRUCTURE_SYNC_IDENTITY: V56_STABLE</div>
         ...
         <div className="space-y-4">
            ...
            <p className="text-white/30 text-[10px] uppercase font-black tracking-[0.4em] italic leading-relaxed">System: {error}<br/>Cloud Bridge: V56_ABSOLUTE_SHIELD</p>
         </div>
